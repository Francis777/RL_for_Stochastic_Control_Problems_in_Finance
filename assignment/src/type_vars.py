...
Rf = Mapping[Tuple[S, A], float]  # reward function
Vf = Mapping[S, float]  # state value function
Qf = Mapping[Tuple[S, A], float]  # action value function
Pf = Mapping[S, A]  # (deterministic) policy
